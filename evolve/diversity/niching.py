...
def crowding_distance(
    ...
    for m in range(n_objectives):
        ...
        # Get range
        f_max = fitness_values[sorted_indices[-1]][m] if m < len(fitness_values[sorted_indices[-1]]) else 0.0
        f_min = fitness_values[sorted_indices[0]][m] if m < len(fitness_values[sorted_indices[0]]) else 0.0
        f_range = f_max - f_min
