        ...
        if i < choosy_count:
            ...
            protocol = ReproductionProtocol(
                ...
                matchability=MatchabilityFunction(
                    ...
                    params={"min_fitness": CHOOSY_THRESHOLD}
                ),
            ...
            protocol = ReproductionProtocol(
                ...
                matchability=MatchabilityFunction(
                    type="fitness_threshold",
                    params={"min_fitness": EAGER_THRESHOLD}
                ),
                crossover=CrossoverProtocolSpec(
                    type=CrossoverType.UNIFORM,
                    params={"swap_probability": 0.5}
...
def main():
    ...
    print("=" * 70)
    print("\nScenario:")
    print(f"  • {int(POPULATION_SIZE * CHOOSY_FRACTION)} choosy individuals (threshold={CHOOSY_THRESHOLD})")
    print(f"  • {POPULATION_SIZE - int(POPULATION_SIZE * CHOOSY_FRACTION)} eager individuals (threshold={EAGER_THRESHOLD})")
    ...
    mutation_config = MutationConfig(
        ...
        param_mutation_strength=0.05,
        type_mutation_rate=0.02
    )
