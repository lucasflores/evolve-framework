...
def analyze_speciation_results(initial_pop: Population, final_pop: Population, history: HistoryCallback):
...
def main():
    ...
    print(f"  • Multi-modal landscape (Rastrigin function)")
    print("\nHypothesis:")
    ...
    initial_pop_copy = Population(individuals=[
        Individual(
