...
class TestHypervolume:
    ...
    def test_hypervolume_with_configured_reference(self):
        ...
        collector = MultiObjectiveMetricCollector(reference_point=[1.0, 1.0])
        metrics = collector.collect(context)
    ...
    def test_hypervolume_reference_from_context_extra(self):
        ...
        context = make_context(pareto_front=front, extra={"hypervolume_reference": [0.0, 0.0]})
    ...
    def test_hypervolume_3d_approximate(self):
        ...
        collector = MultiObjectiveMetricCollector(reference_point=[0.0, 0.0, 0.0])
        metrics = collector.collect(context)
...
class TestHighDimensionalFallback:
    ...
    def test_4d_uses_approximate(self, caplog):
        ...
        collector = MultiObjectiveMetricCollector(reference_point=[0.0, 0.0, 0.0, 0.0])
