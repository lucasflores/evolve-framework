...
class TestMigrationPolicies:
    ...
    def test_best_migration_returns_copies(self):
        ...
        population = [
            create_test_individual("ind_0", np.ones(5), fitness_value=10.0)
        ]
...
class TestMigrationController:
    ...
    def test_migrate_ring_topology(self):
        ...
        original_bests = [
            island.best_individual.fitness.values[0]
...
class TestIslandModelDeterminism:
    ...
    def test_migration_determinism_property(self):
        ...
        for _ in range(3):
            ...
            # Extract state
            state = tuple(
                tuple(ind.fitness.values[0] for ind in island.population)
                for island in islands
            )
