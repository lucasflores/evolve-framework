...
class TestSexualSelectionExample:
    ...
    def test_sexual_selection_detects_selection_effect(self):
        ...
        assert ("sexual selection effect" in stdout or 
                "selection effect" in stdout or
                "Weak selection effect" in stdout)
...
class TestAllExamplesTogether:
    ...
    def test_no_examples_crash(self):
        ...
        for script in examples:
            ...
            assert "Error:" not in stderr or "Error" in stdout  # Allow intentional error messages in stdout
