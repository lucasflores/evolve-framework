...
from evolve.rl.environment import Space, SimpleEnvironment, GymAdapter
from evolve.rl.policy import LinearPolicy, MLPPolicy, RecurrentPolicy
from evolve.rl.rollout import StandardRollout, RolloutResult, evaluate_policy
from evolve.rl.evaluator import RLEvaluator, PolicyDecoder
...
class TestPolicies:
    ...
    def test_linear_policy_from_parameters(self):
        ...
        policy = LinearPolicy.from_parameters(
    ...
    def test_mlp_policy_from_parameters(self):
        ...
        policy = MLPPolicy.from_parameters(
            params, layer_sizes=[4, 8, 2], discrete=True
        )
